...
export const PhotoshopToolbar: React.FC<Props> = memo(({
  ...
  return (
    <div className="relative h-full min-h-0 pointer-events-auto select-none flex flex-col justify-center max-h-[calc(100vh-100px)]">
      {/* Primary Vertical Photoshop Toolbar */}
      <div className="flex flex-col flex-wrap content-start items-center justify-center bg-zinc-900/95 backdrop-blur-md border border-zinc-800 p-1 rounded-2xl shadow-2xl gap-0.5 max-h-full overflow-y-auto scrollbar-none">
        ...
        <div className="w-5 h-[1px] bg-zinc-800 my-0.5" />
        ...
        >
          <Triangle className="w-3.5 h-3.5 sm:w-4 sm:h-4 rotate-90" />
        </button>
        ...
        {onOpenLayersConfig && (
          <>
            ...
            <button
              ...
              className="p-1.5 rounded-xl transition-all text-amber-400 hover:text-amber-300 hover:bg-amber-500/15"
